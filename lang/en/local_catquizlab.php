...
$string['privacy:metadata'] = 'The CAT experiment suite stub stores experiment definitions only (name, tier, configuration) and no personal data. This will change when the lab store gains simulated-user cohorts and attempt traces; the privacy provider will then be extended accordingly.';
